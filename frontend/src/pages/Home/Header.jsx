    ...
    <section className="w-full bg-green-50 h-fit">
      <main className="w-10/12 h-fit mx-auto flex lg:flex lg:flex-row gap-10 justify-between items-center flex-col-reverse py-10">
        <section className="w-full flex flex-col gap-4 items-center lg:items-start lg:w-1/2 ">
          ...
          <p className="text-center lg:text-start text-lg text-light_gray font-roboto_font text-wrap">
            With our comprehensive API, you can access detailed information
            about Nigeria's regions, states, and local government areas (LGAs).
            Whether you're building applications for Nigeria's vast population
            or conducting research, Locale has you covered.
          </p>
          <a
            href="#"
