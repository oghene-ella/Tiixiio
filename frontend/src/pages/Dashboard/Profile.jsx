      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mt-4.5 mb-5.5  rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="mx-auto max-w-180">
                <h4 className="font-semibold text-black dark:text-white">
                  About Me
                </h4>
                <p className="mt-4.5">
                I am a passionate developer driven by a relentless curiosity to explore the vast realm of technology. With a foundation in various programming languages and frameworks, I thrive on crafting efficient and elegant solutions to complex problems. Iam excited to leverage APIs to enhance my development projects, seamlessly integrating external services and data sources to create dynamic and interactive experiences. With a keen eye for API documentation and a knack for understanding endpoints, I am poised to harness the full potential of these interfaces to streamline workflows and deliver robust solutions to users.
                </p>
              </div>
            </div>
